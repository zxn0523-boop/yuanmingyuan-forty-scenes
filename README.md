...
最简单的输入只需要**一张 PNG 截图**：建筑完整、视角清楚即可。

如果想告诉 Codex 哪里是地形，直接在截图上涂一大片半透明黄色：
...
需要区分更多类型时，可选用：绿色＝平地，红色＝山体，蓝色＝水体。初次使用不需要掌握这些进阶标注。
...
不需要再次解释黄色。Skill 会把大片黄色色块理解为通用地形，并默认输出两版：
